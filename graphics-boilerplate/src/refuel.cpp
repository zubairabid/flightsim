...
Refuel::Refuel(float x, float y, float z, float rot, color_t color) {
...
void Refuel::draw(glm::mat4 VP) {
    ...
    // No need as coords centered at 0, 0, 0 of refuel arouund which we waant to rotate
...
void Refuel::set_position(float x, float y, float z) {
    this->position = glm::vec3(x, y, z);
}
